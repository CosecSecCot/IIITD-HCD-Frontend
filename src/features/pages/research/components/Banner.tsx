...
export default function Banner({
  ...
  return (
    <section role="banner" className="relative min-h-[45vh] bg-brand-accent2">
      <p className="reveal-animation-clip absolute top-[84px] lg:top-[146px] xl:top-[176px] mt-[2em] right-[12.5vw] text-[12px] lg:text-[20px] text-white">
      ...
      <h1 className="reveal-animation-clip uppercase absolute bottom-4 left-[12.5vw] text-[28px] lg:text-[72px] text-white">
        {text}
      </h1>
      <Image
