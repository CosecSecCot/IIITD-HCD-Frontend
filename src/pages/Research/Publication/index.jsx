...
const publications = [
  // 2025
  {
    ...
    avatar: prof1,
    desc: "We are a collective of diverse thinkers reimagining how.",
    details: {
      title: "Metaverse Education for Global South",
      abstract:
      ...
      link: "https://doi.org/10.1007/978-3-031-42293-5_93",
    },
  },
  {
    id: 2,
      ...
      {expanded ? (
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 flex flex-col justify-between">
            <div>
              <h3 className="text-[24px] lg:text-[32px] font-medium mb-4 reveal-animation-text">
                {pub.details.title}
              </h3>
              <div className="text-[20px] font-medium mb-2 reveal-animation-text">
                {pub.name}
              </div>
              <p className="text-[16px] opacity-80 mb-2 reveal-animation-text">
                {pub.desc}
              </p>
              <p className="text-[16px] opacity-70 mb-4 reveal-animation-text">
                {pub.details.abstract}
              </p>
            </div>
            <div className="flex justify-between items-center">
              <a
                href={pub.details.link}
                className="underline font-medium reveal-animation-opacity-only"
                target="_blank"
              ...
              <button
                type="button"
                onClick={onCollapse}
                className="underline text-[14px] flex items-center gap-2 reveal-animation-opacity-only"
              >
        ...
        <div className="flex items-center">
          <img
            src={pub.avatar}
            alt={pub.name}
            className="w-[80px] h-[100px] object-cover rounded-md mr-5 reveal-animation-opacity-only"
          />
          <div className="flex-1 flex flex-col justify-center">
            <div className="font-medium text-[16px] mb-1 reveal-animation-text">
              {pub.name}
            </div>
            <p className="text-[14px] opacity-60 mb-2 reveal-animation-text">
              {pub.desc}
            </p>
            <button
              type="button"
              onClick={onExpand}
              className="inline-flex items-center font-semibold text-[14px] gap-2 reveal-animation-opacity-only"
            >
        ...
        >
          {years.map((year) => (
            <div key={year} className="col-span-3 bg-white">
              <div className="text-[20px] lg:text-[32px] font-bold text-[#096964] py-4 px-4">
                {year}
              </div>
