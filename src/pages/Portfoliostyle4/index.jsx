  ...
  return (
    <div className="relative w-full font-anybody bg-white text-[#003B3F]">
      ...
      <main ref={containerRef} className="pt-[210px] px-[12.5vw] pb-10">
        ...
        <div className="flex justify-between items-center mb-6 text-base text-brand-green reveal-text">
        ...
        <div className="border border-brand-green rounded-sm p-8 flex flex-wrap justify-between items-center gap-8 bg-[#F9FDFD] reveal-text">
          <div className="flex flex-col gap-8 flex-1 min-w-[250px]">
            <div className="flex flex-wrap gap-20">
              <div>
                ...
                <p className="text-[18px] font-regular text-brand-green">Sagar Gupta</p>
              </div>
              <div>
                <p className="text-[#005c5c80] uppercase text-sm tracking-wide">Graduating Year</p>
                <p className="text-[17px] text-brand-green font-regular">2027</p>
              </div>
              <div>
                <p className="text-[#005c5c80] uppercase text-sm tracking-wide">Course</p>
                <p className="text-[17px] text-brand-green font-regular">CS & Design</p>
              </div>
            </div>
            <div className="flex flex-wrap gap-20">
              <div>
                <p className="text-[#005c5c80] uppercase text-sm tracking-wide">Email</p>
                <p className="text-[17px] text-brand-green font-regular">sagar23458@iiitd.ac.in</p>
              </div>
              <div>
                <p className="text-[#005c5c80] uppercase text-sm tracking-wide">Phone</p>
                <p className="text-[17px] text-brand-green font-regular">+91 9310121033</p>
              </div>
            </div>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center bg-brand-green text-white px-6 py-3 rounded text-base w-[250px] font-semibold justify-center reveal-text"
            >
        ...
        <div className="mt-8 reveal-text">
          <h2 className="text-lg font-semibold mb-4 text-brand-green">Skills & Softwares</h2>
          <div className="border border-brand-green rounded-sm p-6 bg-[#F9FDFD]">
            <div className="flex flex-wrap gap-6">
              {[
                ...
                <span key={skill} className="bg-brand-green text-white px-4 py-2 text-sm font-medium reveal-text">
                  {skill}
                </span>
              ))}
            </div>
        ...
        <div className="mt-12 flex reveal-text">
          <div className="w-1/2 pr-12">
            <h2 className="text-lg font-semibold mb-4 text-brand-green">Education</h2>
            <div className="mb-6">
              <div className="flex justify-between items-start mb-2">
                ...
                <div className="flex items-start">
                  ...
                  <div className="text-right mt-4">
                    <p className="text-brand-green uppercase text-xs tracking-wide">CGPA</p>
                    <p className="text-brand-green font-medium text-base mb-3">8.65</p>
                  </div>
                </div>
              </div>
              <p className="text-brand-green text-sm">2023-2027</p>
            </div>
            <div>
              <div className="flex justify-between items-start mb-2">
                <div className="flex-1">
                ...
                <div className="flex items-start">
                  ...
                  <div className="text-right mt-4">
                    <p className="text-brand-green uppercase text-xs tracking-wide">PERCENTAGE</p>
                    <p className="text-brand-green font-medium text-base mb-5">92.8%</p>
                  </div>
                </div>
              </div>
              <p className="text-brand-green text-sm">2023-2027</p>
          ...
          <div className="w-1/2 flex justify-end">
            <div className="w-full max-w-[400px]">
              <h2 className="text-lg font-semibold mb-4 text-brand-green">Awards & Achievements</h2>
              <div className="mb-6">
                <p className="text-[#005c5c80] uppercase text-xs tracking-wide mb-1">IIIT DELHI</p>
                <p className="text-brand-green font-semibold text-base">
                  Dean's List Communication Award in Design
                </p>
                <p className="text-brand-green text-sm">August 2024</p>
              </div>
              <div>
                <p className="text-[#005c5c80] uppercase text-xs tracking-wide mb-1">IIIT DELHI</p>
                <p className="text-brand-green font-semibold text-base">
        ...
        <div className="mt-8 reveal-text">
          <h2 className="text-lg font-semibold mb-4 text-brand-green">Experience</h2>
          {[1,2].map((_,idx)=>(
            <div key={idx} className="mb-8">
              <div className="mb-2">
                <p className="text-brand-green uppercase text-xs tracking-wide mb-1">HEALTHKART</p>
                <div className="flex justify-between items-center">
                  <p className="text-brand-green font-semibold text-[17px]">
                    User Experience Design Intern
                  </p>
                  <div className="flex items-center">
                    <div className="w-[700px] h-px bg-[#096964] mx-4"></div>
                    <p className="text-brand-green text-[17px]">May, 2025 - July, 2025</p>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-8 reveal-text">
          <h2 className="text-lg font-semibold mb-4 text-brand-green">Projects</h2>
          <div className="flex gap-8">
            <div className="w-1/3 reveal-text">
              <p className="text-brand-green uppercase text-xs tracking-wide mb-1">HEALTHKART</p>
              <h3 className="text-brand-green font-semibold text-[17px] mb-3">
              ...
              <div className="mb-4">
                <p className="text-brand-green uppercase text-xs tracking-wide mb-2">TECH STACK</p>
                <div className="flex flex-wrap gap-2">
                  <span className="bg-brand-green text-white px-3 py-1 text-xs font-medium">FIGMA</span>
                  <span className="bg-brand-green text-white px-3 py-1 text-xs font-medium">ILLUSTRATOR</span>
                </div>
                <div className="flex flex-wrap gap-2 mt-2">
                  <span className="bg-brand-green text-white px-3 py-1 text-xs font-medium">FIGJAM</span>
                  <span className="bg-brand-green text-white px-3 py-1 text-xs font-medium">RESEARCH</span>
                </div>
              </div>
              <p className="text-brand-green text-[17px] font-medium mb-4">Duration: May, 25 - Jul, 25</p>
              <button className="w-full border border-brand-green text-brand-green px-6 py-2 text-[17px] font-medium hover:bg-brand-green hover:text-white transition reveal-text">
