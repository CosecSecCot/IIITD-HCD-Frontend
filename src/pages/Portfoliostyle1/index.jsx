  ...
  return (
    <div className="relative w-full font-anybody bg-white text-[#003B3F]">
      ...
      <main ref={containerRef} className="pt-[210px] px-[12.5vw] pb-10">
        <img
          src={vectorBg}
          className="absolute top-[1vh] right-[7vw] w-[80vw] h-full m-0 p-0" />

        <div className="flex justify-between items-center mb-6 text-base text-[#005C5C] reveal-text">
        ...
        <div className="border border-[#005C5C] rounded-sm p-8 flex flex-wrap justify-between items-center gap-8 bg-[#F9FDFD] reveal-text">
          <div className="flex flex-col gap-8 flex-1 min-w-[250px]">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center bg-[#005C5C] text-white px-6 py-3 rounded text-base w-[250px] font-semibold justify-center reveal-text"
            >
          ...
          <div className="border border-[#005C5C] rounded-sm p-6 bg-[#F9FDFD]">
            <div className="flex flex-wrap gap-6">
              {[
                ...
                <span key={skill} className="bg-[#005C5C] text-white px-4 py-2 text-sm font-medium reveal-text">
                  {skill}
                </span>
              ))}
            </div>
            ...
            <div className="mb-6">
              <div className="flex justify-between items-start mb-2">
                <div className="flex-1">
                  ...
                  <p className="text-[#005C5C] font-medium text-base">
          ...
          <div className="w-1/2 flex justify-end">
            <div className="w-full max-w-[400px]">
              ...
              <div className="mb-6">
                ...
                <p className="text-[#005C5C] font-semibold text-base">
            ...
            <div key={idx} className="mb-8">
              <div className="mb-2">
                ...
                <div className="flex justify-between items-center">
                  <p className="text-[#005C5C] font-semibold text-[17px]">
        ...
        <div className="mt-8 reveal-text">
          ...
          <div className="flex gap-8">
            <div className="w-1/3 reveal-text">
              <p className="text-[#005C5C] uppercase text-xs tracking-wide mb-1">HEALTHKART</p>
              <h3 className="text-[#005C5C] font-semibold text-[17px] mb-3">
              ...
              <p className="text-[#005C5C] text-[17px] font-medium mb-4">Duration: May, 25 - Jul, 25</p>
              <button className="w-full border border-[#005C5C] text-[#005C5C] px-6 py-2 text-[17px] font-medium hover:bg-[#005C5C] hover:text-white transition reveal-text">
