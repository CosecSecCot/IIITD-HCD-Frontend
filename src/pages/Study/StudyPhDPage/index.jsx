    ...
    <div className="relative font-anybody">
      ...
      <section className="mt-[64px] lg:mt-[100px]">
        ...
        <p className="ml-[12.5vw] xl:ml-[37.5vw] mt-[32px] lg:mt-[80px] w-[75vw] xl:w-[50vw] text-[16px] lg:text-[24px] font-light">
          ...
          depth of a student, followed by focused research. Admissions are made
          through regular admission process as well as rolling mode. Regular
          admissions for all disciplines are made in March-April and Nov-Dec
          every year. For rolling admission, the interested candidates are
          expected to interact with the concerned faculty member(s) in
