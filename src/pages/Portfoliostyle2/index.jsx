...
import sagarImage from '../../assets/sagarblue.svg';
import linkedinIcon from '../../assets/linkedin.svg';


const Portfolio2 = () => {
  return (
    <div className="font-sans bg-white text-[#093B69]">
      ...
      <div className="pt-[210px] px-[12.5vw] pb-10">
        ...
        {/* Main card */}
        <div className="border border-[#093B69] rounded-sm p-8 flex justify-between items-center bg-[#093b690b] flex-wrap gap-8">
        ...
        <div className="mt-8">
          ...
          <div className="border border-[#093B69] rounded-sm p-6 bg-[#093b690b]">
            <div className="flex flex-wrap gap-6">
              <span className="bg-[#093B69] text-white px-4 py-2 text-sm font-medium">FIGMA</span>
              <span className="bg-[#093B69] text-white px-4 py-2 text-sm font-medium">ADOBE ILLUSTRATOR</span>
              <span className="bg-[#093B69] text-white px-4 py-2 text-sm font-medium">ADOBE PHOTOSHOP</span>
              <span className="bg-[#093B69] text-white px-4 py-2 text-sm font-medium">UNITY 3D</span>
              <span className="bg-[#093B69] text-white px-4 py-2 text-sm font-medium">UNREAL ENGINE</span>
              <span className="bg-[#093B69] text-white px-4 py-2 text-sm font-medium">FUSION 360</span>
              <span className="bg-[#093B69] text-white px-4 py-2 text-sm font-medium">Python</span>
              <span className="bg-[#093B69] text-white px-4 py-2 text-sm font-medium">C++</span>
              <span className="bg-[#093B69] text-white px-4 py-2 text-sm font-medium">Java</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8">
          ...
          <div className="mb-8">
            <div className="mb-2">
              <p className="text-[#093B69] uppercase text-xs tracking-wide mb-1">HEALTHKART</p>
              ...
              <div className="mb-4">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="bg-[#093B69] text-white px-3 py-1 text-xs font-medium">FIGMA</span>
                    <span className="bg-[#093B69] text-white px-3 py-1 text-xs font-medium">ILLUSTRATOR</span>
                  </div>
                  <div className="flex flex-wrap gap-2 mt-2">
                    <span className="bg-[#093B69] text-white px-3 py-1 text-xs font-medium">FIGJAM</span>
                    <span className="bg-[#093B69] text-white px-3 py-1 text-xs font-medium">RESEARCH</span>
                  </div>
                </div>

                {/* Duration */}
                <div className="mb-6">
                  <p className="text-[#093B69] text-[17px]">
                    <span className="font-medium">Duration:</span> May, 25 - Jul, 25
                  </p>
                </div>

                {/* View Project Details Button */}
                <button className="border border-[#093B69] text-[#093B69] px-6 py-2 text-[17px] font-medium hover:bg-[#093B69] hover:text-white transition-colors w-full bg-[#093b690b]">
