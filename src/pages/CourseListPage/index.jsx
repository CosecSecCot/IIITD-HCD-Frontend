      ...
      <div className="relative z-10 flex items-center justify-center min-h-[80vh] px-[160px] pt-[240px]">
        <div className="grid grid-cols-12 gap-4 w-full">
          ...
          <div className="col-span-6">
            <button className="text-[#084c4c] text-[20px] font-normal mb-4">
              ← Go Back
            </button>
          ...
          <div className="col-span-6 flex items-center justify-end mt-5">
            <p className="font-light italic text-[18px] text-right leading-relaxed max-w-md">
              ...
              services and systems which combine emerging
              <br /> technologies"
            </p>
          </div>
        </div>
        ...
        <div className="max-w-[1200px] mx-auto mt-10 border border-[#cdd5cd]">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            {courses.map((course, idx) => (
              ...
              >
                <p className="text-sm text-[#198c88] font-medium mb-1">
                  {course.credits}
                </p>
                <h3 className="text-black font-semibold text-[18px] mb-1 leading-tight">
                  {course.title}
                </h3>
                <p className="text-sm text-gray-800 mb-1">
                  <span className="font-medium text-black">Acronym:</span>{" "}
                  {course.acronym} &nbsp;&nbsp;
                ...
                <div className="flex justify-end">
                  <a
                    href="#"
                    className="text-[#198c88] text-sm font-semibold hover:underline flex items-center"
                  >
